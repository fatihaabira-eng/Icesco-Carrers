...
const Record: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append('video', recordedBlob, 'introduction.webm');
      ...
      // For now, store in memory (simulated upload)
      console.log('Video stored in memory:', recordedBlob);
      alert('Video submitted successfully!');
      navigate('/steps'); // Redirect back to form
    } catch (err) {
